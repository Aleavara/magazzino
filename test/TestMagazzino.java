...
import GestioneMagazzino.ProdottoException;
...
public class TestMagazzino {
    ...
    public void testVisualizzaProdotti() {
        // Non è possibile testare direttamente il metodo visualizzaProdotti(),
        // ma possiamo testare che la lista dei prodotti non sia vuota
    ...
    public void testRicercaProdotto() {
        assertNotNull(magazzino.ricercaProdotto("1234"));
        assertNull(magazzino.ricercaProdotto("9999"));
    }
